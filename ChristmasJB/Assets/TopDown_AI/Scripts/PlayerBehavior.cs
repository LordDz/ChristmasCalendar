...
public class PlayerBehavior : MonoBehaviour
{
    ...
    int hashSpeed;
    float attackTimeKnife = 0.4f;
    float attackTimeSciGun = 0.8f;
    ...
    public void Attack()
    {
        switch (currentWeapon)
        {
            case PlayerWeaponType.KNIFE:
                ...
                Invoke("AttackOver", attackTimeKnife);
                attackTimer.StartTimer(attackTimeKnife);
                break;
            case PlayerWeaponType.PISTOL:
                ...
                AlertEnemies();
                Invoke("AttackOver", attackTimeSciGun);
                attackTimer.StartTimer(attackTimeSciGun);
                break;
        }
    ...
    void AlertEnemies()
    {
        RaycastHit[] hits = Physics.SphereCastAll(hitTestPivot.position, 5.0f, hitTestPivot.up);
